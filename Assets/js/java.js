let APIKey = "7ff8ebfea098ff405322b7359f08920f";
let locations = [];
...
function getWeatherData(lat, lon, city) {
 ...
 //call the weather API based on ZipCode and call the function showWeatherData to load the values
function loadWeatherZip(zipCpde, isClicked) {
  console.log(loadWeatherZip)
